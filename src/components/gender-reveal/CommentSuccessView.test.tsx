...
describe('CommentSuccessView', () => {
  it('태명과 보낸 사람 이름이 반영된 안내 문구를 렌더링한다', () => {
    render(<CommentSuccessView babyNickname="콩이" senderName="지민" onViewComments={jest.fn()} />);
  ...
  it('덕담 보러가기 클릭 시 onViewComments를 호출한다', async () => {
    ...
    render(<CommentSuccessView babyNickname="콩이" senderName="지민" onViewComments={onViewComments} />);
